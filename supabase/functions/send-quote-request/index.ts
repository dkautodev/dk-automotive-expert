  ...
  try {
      ...
      htmlContent: `
        <div style="font-family: 'Segoe UI', Arial, sans-serif; background: #f5f7fa; padding: 32px;">
          <div style="background: #fff; border-radius: 8px; max-width: 680px; margin: auto; padding: 32px; box-shadow: 0 4px 32px rgba(55, 92, 194, 0.10); border: 1px solid #e2e8f0;">
            <img src="https://www.dkautomotive.fr/upload/64b69a10-c303-48f4-9b56-7bee8e58a109.png" alt="DK Automotive" style="height: 62px; margin-bottom: 12px; display: block;" />
    ...
    const clientEmailPayload = {
      ...
      htmlContent: `
        <div style="font-family: 'Segoe UI', Arial, sans-serif; background: #f5f7fa; padding: 32px;">
          <div style="background: #fff; border-radius: 8px; max-width: 680px; margin: auto; padding: 32px; box-shadow: 0 4px 32px rgba(55, 92, 194, 0.10); border: 1px solid #e2e8f0;">
            <img src="https://53a7f645-5239-4564-a038-600cd9086c4f.lovableproject.com/upload/64b69a10-c303-48f4-9b56-7bee8e58a109.png" alt="DK Automotive" style="height: 62px; margin-bottom: 12px; display: block;" />
