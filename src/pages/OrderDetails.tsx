...
const OrderDetails = () => {
  ...
  return <div className="p-6 space-y-6">
      ...
      <OrderSummary pickupAddress={orderDetails.pickupAddress} deliveryAddress={orderDetails.deliveryAddress} selectedVehicle={orderDetails.selectedVehicle} distance={distance} priceHT={priceHT} onShowContacts={handleShowContacts} getVehicleName={getVehicleName} onDateUpdate={handleDateUpdate} pickupDate={pickupDate} deliveryDate={deliveryDate} />

      {showContacts && <div id="contacts-section">
          <ContactsForm onContactsValid={setAreContactFieldsValid} onShowVehicle={handleShowVehicle} onContactsUpdate={handleContactsUpdate} />
        </div>}

      {showVehicle && <div id="vehicles-section">
