...
const PendingQuotes = () => {
  ...
  return <div className="p-6">
      <div className="relative mb-6">
        <Button variant="outline" onClick={() => navigate("/dashboard/client")} className="absolute left-0 gap-2">
          ...
          <Table>
            ...
            <TableBody>
              {quotes.map(quote => <TableRow key={quote.id}>
                  ...
                  <TableCell>
                    {format(new Date(quote.dateCreated), 'dd MMMM yyyy', {
                  locale: fr
                })}
                  </TableCell>
                  ...
                  <TableCell>
                    <div className="flex justify-center gap-2">
                      <Button variant="outline" size="icon" onClick={() => handleViewQuoteDetails(quote)} title="Voir les détails">
                        <Eye className="h-4 w-4" />
                      </Button>
                      <Button variant="outline" size="icon" onClick={() => handleGeneratePDF(quote)} title="Télécharger le PDF">
                        <Download className="h-4 w-4" />
                      </Button>
                      <AlertDialog>
                        <AlertDialogTrigger asChild>
                          <Button variant="outline" size="icon" className="text-red-500 hover:text-red-600" title="Supprimer">
                            <X className="h-4 w-4" />
                          </Button>
                        </AlertDialogTrigger>
                        <AlertDialogContent>
