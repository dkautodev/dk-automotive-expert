        ...
        <div className="flex gap-4 items-start">
          <Popover>
            ...
            <PopoverContent className="w-auto p-0" align="start">
              <Calendar mode="single" selected={orderDetails.deliveryDate} onSelect={onDeliveryDateSelect} disabled={date => date < orderDetails.pickupDate} initialFocus locale={fr} className={cn("p-3 pointer-events-auto")} />
            </PopoverContent>
          </Popover>
