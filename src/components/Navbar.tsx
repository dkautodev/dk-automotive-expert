...
const Navbar = () => {
  ...
  return <nav className="bg-white shadow-sm border-b fixed top-0 left-0 right-0 z-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-0 py-[12px]">
        <div className="flex justify-between h-16">
          ...
          <div className="hidden md:flex items-center space-x-8">
            ...
            <a href="https://app-private.dkautomotive.fr" target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-2 px-4 py-2 text-sm font-medium text-blue-600 bg-blue-50 border border-blue-200 rounded-lg hover:bg-blue-100 transition-colors">
        ...
        {isMenuOpen && <div className="md:hidden">
            <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3 bg-white border-t">
              ...
              <a href="https://app-private.dkautomotive.fr" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 px-3 py-2 text-base font-medium text-blue-600 hover:bg-blue-50 transition-colors" onClick={() => setIsMenuOpen(false)}>
                <User className="w-4 h-4" />
                Espace professionnel
              </a>
            </div>
