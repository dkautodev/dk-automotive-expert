          ...
          <div className="flex flex-col space-y-1 p-2">
            <Link
              ...
              className={cn(
                ...
                isActive("/dashboard/client") ? "bg-gray-100 font-medium" : "hover:bg-gray-100"
              )}
            ...
            <Link
              ...
              className={cn(
                "flex items-center space-x-2 px-3 py-2 rounded-md transition-colors",
                isActive("/dashboard/client/profile") ? "bg-gray-100 font-medium" : "hover:bg-gray-100"
              )}
              onClick={() => isMobile && toggleCollapsed()}
            >
            ...
            <Link
              ...
              className={cn(
                "flex items-center space-x-2 px-3 py-2 rounded-md transition-colors",
                isActive("/dashboard/client/pending-quotes") ? "bg-gray-100 font-medium" : "hover:bg-gray-100"
              )}
              onClick={() => isMobile && toggleCollapsed()}
            >
            ...
            <Link
              to="/dashboard/client/ongoing-shipments"
              className={cn(
                "flex items-center space-x-2 px-3 py-2 rounded-md transition-colors",
                isActive("/dashboard/client/ongoing-shipments") ? "bg-gray-100 font-medium" : "hover:bg-gray-100"
              )}
              onClick={() => isMobile && toggleCollapsed()}
            >
            ...
            <Link
              to="/dashboard/client/completed-shipments"
              className={cn(
                "flex items-center space-x-2 px-3 py-2 rounded-md transition-colors",
                isActive("/dashboard/client/completed-shipments") ? "bg-gray-100 font-medium" : "hover:bg-gray-100"
              )}
              onClick={() => isMobile && toggleCollapsed()}
            >
              <ClipboardList className="h-4 w-4" />
    ...
    <div className="fixed inset-y-0 left-0 w-52 bg-white border-r border-gray-200 z-10">
      ...
      <div className="flex flex-col space-y-1 p-2">
        <Link
          ...
          className={cn(
            "flex items-center space-x-2 px-3 py-2 rounded-md transition-colors",
            isActive("/dashboard/client") && location.pathname === "/dashboard/client" ? "bg-gray-100 font-medium" : "hover:bg-gray-100"
          )}
        >
          <LayoutDashboard className="h-4 w-4" />
          <span>Tableau de bord</span>
