...
const Footer = () => {
  return <footer className="bg-[#18257D] text-white py-16">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12">
          {/* Logo and Description */}
          <div className="col-span-1 md:col-span-1 text-center md:text-left">
            <img src="/lovable-uploads/0569d88f-5ec1-4822-8cae-a5f0ba017d54.png" alt="DK AUTOMOTIVE" className="h-20 mb-4 mx-auto md:mx-0 brightness-0 invert" />
          ...
          <div className="col-span-1 text-center md:text-left">
            ...
            <form className="space-y-2" onSubmit={e => e.preventDefault()}>
              <div className="flex gap-2">
                <Input type="email" placeholder="Email *" className="bg-white/10 border-white/20 text-white placeholder:text-white/50" />
        ...
        <div className="mt-16 pt-8 border-t border-white/10 py-0 my-0">
