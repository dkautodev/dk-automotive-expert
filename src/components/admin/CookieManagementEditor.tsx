  ...
  return (
    <div className="max-w-4xl mx-auto p-6 space-y-6">
      ...
      <div className="flex justify-between items-start">
        <div>
          <h1 className="text-2xl font-bold text-dk-navy mb-2">Gestion des cookies</h1>
          <p className="text-sm text-muted-foreground">
            Gérez le contenu de votre page de gestion des cookies.
          </p>
        </div>
        ...
        <AccordionItem value="sections" className="border rounded-lg px-4">
          <AccordionTrigger className="hover:no-underline py-4">
            <div className="flex items-center gap-3">
              ...
              <span className="font-semibold">Sections ({cookieManagementSections.length})</span>
            </div>
          </AccordionTrigger>
          <AccordionContent className="pb-4 space-y-4">
            {cookieManagementSections.map((section) => (
