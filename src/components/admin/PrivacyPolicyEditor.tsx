...
const PrivacyPolicyEditor = () => {
  const { privacyPolicySections, isLoading, updatePrivacyPolicySection, addPrivacyPolicySection, deletePrivacyPolicySection } = usePrivacyPolicy();
  ...
  const handleSave = async () => {
    ...
    setIsSaving(true);
    const success = await updatePrivacyPolicySection(editingSection, {
    ...
    return (
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center py-12">
          ...
          <p>Chargement des sections de politique de confidentialité...</p>
        </div>
      </div>
    );
  }
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      <div className="mb-8 flex justify-between items-start">
        <div>
          <h2 className="text-2xl font-bold text-dk-navy mb-2">Éditeur - Politique de confidentialité</h2>
          <p className="text-gray-600">Gérez le contenu de votre politique de confidentialité</p>
        </div>
      ...
      <div className="space-y-6">
        {privacyPolicySections.map((section, index) => (
          <Card key={section.id}>
            ...
            {index < privacyPolicySections.length - 1 && <Separator className="mt-4" />}
          </Card>
        ))}
      </div>
    </div>
