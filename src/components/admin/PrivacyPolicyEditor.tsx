  ...
  return (
    <div className="max-w-4xl mx-auto p-6 space-y-6">
      ...
      <div className="flex justify-between items-start">
        <div>
          <h1 className="text-2xl font-bold text-dk-navy mb-2">Politique de confidentialité</h1>
        ...
        <AccordionItem value="sections" className="border rounded-lg px-4">
          <AccordionTrigger className="hover:no-underline py-4">
            <div className="flex items-center gap-3">
              ...
              <span className="font-semibold">Sections ({privacyPolicySections.length})</span>
            </div>
          </AccordionTrigger>
